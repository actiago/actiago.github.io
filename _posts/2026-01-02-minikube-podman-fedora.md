...
Recentemente reinstalei o sistema operacional em meu modesto computador de estudos, fiquei um bom tempo utilizando o Ferora 40 workstation e resolvi mudar para a versão Server mais recente. Com esse movimento, precisei reinstalar a stack anterior de estudos do Kuberbetes, nela uso o **Minikube** integrado ao **Podman**, utilizando o runtime **CRI-O** e a rede **Calico**. Em um outro momento irei escrever sobre as motivações da escolha destes componentes.
...
*   **Podman instalado**  
    O Podman será usado como driver para o Minikube. Certifique-se de que ele já está instalado e funcional.
